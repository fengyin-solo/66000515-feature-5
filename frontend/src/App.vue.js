...
if (__VLS_ctx.store.result) {
    ...
    // @ts-ignore
    const __VLS_47 = __VLS_asFunctionalComponent(ConstellationPlot, new ConstellationPlot({}));
    const __VLS_48 = __VLS_47({}, ...__VLS_functionalComponentArgsRest(__VLS_47));
}
if (__VLS_ctx.store.result) {
    /** @type {[typeof WaterfallPlot, ]} */ ;
    // @ts-ignore
    const __VLS_50 = __VLS_asFunctionalComponent(WaterfallPlot, new WaterfallPlot({}));
    const __VLS_51 = __VLS_50({}, ...__VLS_functionalComponentArgsRest(__VLS_50));
}
if (__VLS_ctx.store.result) {
    /** @type {[typeof ModulationResult, ]} */ ;
    // @ts-ignore
    const __VLS_53 = __VLS_asFunctionalComponent(ModulationResult, new ModulationResult({}));
